...
static void H040B24_init_sequence(struct mipi_dsi_multi_context *dsi_ctx)
{
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGIP1,
			0xC8,0x10,0x0A,0x10,0x0F,0xA1,0x80,0x12,0x31,0x23,
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGIP2,
			0x96,0x12,0x01,0x01,0x01,0x78,0x02,0x00,0x00,0x00,
	...
	mipi_dsi_dcs_write_seq_multi(dsi_ctx, ST7703_CMD_SETGAMMA
			0x00,0x0A,0x0F,0x29,0x3B,0x3F,0x42,0x39,0x06,0x0D,
